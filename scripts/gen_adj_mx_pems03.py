'''
Description: Generate adjacency matrix
FilePath: /DMGAN/scripts/gen_adj_mx.py
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/PEMS03/PEMS03.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/PEMS03/PEMS03.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='data/sensor_graph/adj_mx_pems03.pkl',
                        help='Path of the output file.')
    args = parser.parse_args()

    with open(args.sensor_ids_filename) as f:
        sensor_ids = f.read().strip().split('\n')
    # sensor_ids = [str(i) for i in range(170)]
