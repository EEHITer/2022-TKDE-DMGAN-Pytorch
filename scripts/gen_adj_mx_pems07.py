...
if __name__ == '__main__':
    ...
    parser.add_argument('--distances_filename', type=str, default='data/PEMS07/PEMS07.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='data/sensor_graph/adj_mx_pems07.pkl',
                        help='Path of the output file.')
    args = parser.parse_args()

    # with open(args.sensor_ids_filename) as f:
    #     sensor_ids = f.read().strip().split(',')
    sensor_ids = [str(i) for i in range(883)]
